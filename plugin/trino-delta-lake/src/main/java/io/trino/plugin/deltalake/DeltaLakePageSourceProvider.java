        ...
        implements ConnectorPageSourceProvider
{
    ...
    private static final int MAX_RLE_PAGE_SIZE = DEFAULT_MAX_PAGE_SIZE_IN_BYTES / LONG_INSTANCE_SIZE;
    private static final int MAX_RLE_ROW_ID_PAGE_SIZE = DEFAULT_MAX_PAGE_SIZE_IN_BYTES / (LONG_INSTANCE_SIZE * 2);
